...
<style scoped>
.selector{position:relative; z-index:2; box-sizing:border-box; width:100%; height:100%; padding:10px; border-radius:4px; border:1px solid #ddd; line-height:22px;}
...
.selector-option{position:absolute; top:100%; left:0; width:100%; max-height:276px; margin-top:3px; border-radius:4px; box-shadow:0 0 0 1px #ddd; background:#fff; overflow:auto; -webkit-transition:.2s; transition:.2s;}
